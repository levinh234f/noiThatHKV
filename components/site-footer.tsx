...
export default function SiteFooter() {
  return (
    <footer id="footer" className="bg-[#6b7d65] text-white">
      <div className="mx-auto hidden h-[416px] max-w-[1176px] lg:block">
        <div className="relative h-full">
          ...
          <div className="absolute right-0 top-[188px] w-[362px]">
            ...
            <div className="mt-[26px] flex justify-between text-sm"><span>Email:</span><span>Hotline:</span></div>
          </div>
      ...
      <div className="px-7 py-9 lg:hidden">
        ...
        <div className="mt-10">
          <h2 className="text-xl">THÔNG TIN LIÊN HỆ</h2>
          <p className="mt-5 text-sm">Email:</p><p className="mt-3 text-sm">Hotline:</p>
        </div>
